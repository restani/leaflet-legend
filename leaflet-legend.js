(function() {
	...
	L.Control.Legend = L.Control.extend({
		...
		_generateHtml: function() {
			...
			this.hiddenLegendDiv.innerHTML += "<div class='leaflet-bar leaflet-control'><a href='#' title='Show legend' id='legend-show'>=</a></div>";

			this.visibleLegendDiv.innerHTML = "";
			// hide button
			this.visibleLegendDiv.innerHTML += "<div class='leaflet-bar leaflet-control'><a href='#' title='Hide legend' id='legend-hide'>&times;</a></div>";
